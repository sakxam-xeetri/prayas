...
<div class="author-card-container">
  <div class="author-card-header">
    <div class="author-avatar-icon">SB</div>
    <div class="author-info-main">
      <div class="author-title-badge">Lead Systems Architect & Creator</div>
      <h3 class="author-name">Sakshyam Bastakoti</h3>
      <p class="author-subtitle">Robotics Engineer & Firmware Architect | Developer of PRAYAS V1 Distributed Humanoid Architecture</p>
      <div class="author-tags">
        <span class="author-tag-item">Humanoid Robotics</span>
        <span class="author-tag-item">ESP-NOW Wireless Mesh</span>
        <span class="author-tag-item">Embedded AI & Voice</span>
        <span class="author-tag-item">FreeRTOS & Control Systems</span>
      </div>
    </div>
  </div>
  <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap; margin-top: 8px;">
    <a href="https://sakshyambastakoti.com.np" target="_blank" class="author-contact-btn">
      <svg class="doc-icon" viewBox="0 0 24 24" style="fill: currentColor; width: 1.2em; height: 1.2em;"><path d="M12 2A10 10 0 0 0 2 12a10 10 0 0 0 10 10a10 10 0 0 0 10-10A10 10 0 0 0 12 2m6.93 6h-2.95a15.65 15.65 0 0 0-1.38-3.56A8.03 8.03 0 0 1 18.93 8M12 4.04c.83 1.2 1.48 2.53 1.91 3.96h-3.82c.43-1.43 1.08-2.76 1.91-3.96M4.26 14C4.1 13.36 4 12.69 4 12s.1-1.36.26-2h3.38c-.08.66-.14 1.32-.14 2s.06 1.34.14 2H4.26m.81 2h2.95c.32 1.25.78 2.45 1.38 3.56A8.03 8.03 0 0 1 5.07 16m2.95-8H5.07a8.03 8.03 0 0 1 3.56-3.56A15.65 15.65 0 0 0 8.02 8M12 19.96c-.83-1.2-1.48-2.53-1.91-3.96h3.82c-.43 1.43-1.08 2.76-1.91 3.96M14.34 14H9.66c-.09-.66-.16-1.32-.16-2s.07-1.34.16-2h4.68c.09.66.16 1.32.16 2s-.07 1.34-.16 2m.59 5.56c.6-1.11 1.06-2.31 1.38-3.56h2.95a8.03 8.03 0 0 1-3.56 3.56M16.36 14c.08-.66.14-1.32.14-2s-.06-1.34-.14-2h3.38c.16.64.26 1.31.26 2s-.1 1.36-.26 2h-3.38Z"/></svg>
      Visit Portfolio & Contact (sakshyambastakoti.com.np)
    </a>
  </div>
</div>
...
<div class="stat-grid">
  <div class="stat-card">
    <div class="stat-number">7-DOF</div>
    <div class="stat-label">Upper Body Kinematics</div>
  </div>
  <div class="stat-card">
    <div class="stat-number">4WD</div>
    <div class="stat-label">Differential Drivetrain</div>
  </div>
  <div class="stat-card">
    <div class="stat-number">&lt; 10ms</div>
    <div class="stat-label">ESP-NOW Latency</div>
  </div>
  <div class="stat-card">
    <div class="stat-number">Xiaozhi AI</div>
    <div class="stat-label">Voice & MCP Engine</div>
  </div>
</div>
